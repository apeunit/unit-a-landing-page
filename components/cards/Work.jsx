...
const Work = ({ text, title, imageSrc2 }) => {
  return (
    <div className="bg-primary-800 gap-x-6 max-w-7xl mb-6 lg:mb-8 min-w-min lg:max-h-170 text-white rounded-xl lg:mr-20 lg:pl-10 pt-10 lg:pt-32.75 pb-10 lg:pb-26.5 flex lg:flex-row flex-col items-center">

...
const WhoWeAre = () => {
    return ( 
        <section className="flex gap-5 lg:gap-8.75 xl:gap-4.5 flex-col md:px-2 xl:px-0 xl:w-4.38/5 mx-auto">
          ...
          <Heading5>With the new Unit A, we want to shift our focus to African developers and create joint European and African organizations to work in blockchain technology.</Heading5>
          <DefaultButton style="w-64.5 gap-6 md:w-fit text-2xl" text="Contact us" hasArrow={true} hasLink={true} directLink="mailto: u2467@apeunit.com"/>
        </section>
     );
}
